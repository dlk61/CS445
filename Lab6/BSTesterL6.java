public class BSTesterL6
{
	public static void main( String[] args ) throws Exception
	{
		BSTreeL6<String> tree1 = new BSTreeL6<String>( args[0] );
		...
		BSTreeL6<String> tree2 = tree1.makeBalancedCopyOf();  // TREE1 RETURNS BALANCED COPY OF SELF BUT DOES NOT CHANGE SELF
		...
		BSTreeL6<String> tree3 = new BSTreeL6<String>( tree2 );  // SHOULD PRODUCE AN EXACT DEEP COPY
		System.out.format( "tree3: a constructor copy (identical) of tree2 contains %d nodes on %d levels:\n", tree3.countNodes(), tree3.countLevels()  );	
